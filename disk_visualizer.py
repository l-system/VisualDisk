...
from file_rect import FileRect
from treemap_layouter import TreemapLayouter
...
class DiskVisualization:
    ...
    def _update_layout(self):
        plot_width = 1000
        plot_height = 800
        layouter = TreemapLayouter(plot_width, plot_height, self.config.padding)
        self.file_rects = layouter.layout_files(self.current_files)
        self.ax_main.set_xlim(0, plot_width)
        self.ax_main.set_ylim(0, plot_height)
